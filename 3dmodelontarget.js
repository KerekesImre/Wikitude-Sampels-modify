...
var World = {
    ...
    createOverlays: function createOverlaysFn() {
      ...
      //  var imgRotate = new AR.ImageResource("assets/car.png");
        ...
        this.modelTorta = new AR.Model("assets/torta1.wt3", {
                             onLoaded: World.showInfoBar,
                             onError: World.onError,
                             scale: {
                                 x: 0.040,
                         ...
                         this.modelPizza = new AR.Model("assets/pizza.wt3", {
                                              onLoaded: World.showInfoBar,
                                              onError: World.onError,
                                              scale: {
                                                  x: 0.045,
        ...
        */
        ...
        this.trackable = new AR.ImageTrackable(this.tracker, "*", {
            drawables: {
                cam: [ this.modelTorta,this.modelCar]
            },

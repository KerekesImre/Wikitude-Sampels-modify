...
public class SimpleArActivity extends AppCompatActivity {
     ...
     */
    protected WearableArchitectView architectView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Make ArchitectView fullscreen
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        final int FLAG_SMARTFULLSCREEN = 0x80000000;
        final Window window = getWindow();
        final WindowManager.LayoutParams windowAttributes = window.getAttributes();
        windowAttributes.flags |= FLAG_SMARTFULLSCREEN;
    ...
    protected void onResume() {
        ...
        // Enables stereoscopic rendering of the device.
        architectView.setStereoscopic3dDisplayModeEnabled(true);
        // Enables stereoscopic rendering of the ArchitectView.
        architectView.setStereoscopic3dRenderingEnabled(true);
    }

    @Override
    protected void onPause() {
        super.onPause();
        // Disables stereoscopic rendering of the device.
        architectView.setStereoscopic3dDisplayModeEnabled(false);
        // Disables stereoscopic rendering of the ArchitectView.
        architectView.setStereoscopic3dRenderingEnabled(false);
